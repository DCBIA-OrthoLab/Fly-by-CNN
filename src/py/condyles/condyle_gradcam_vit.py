...
def main(args):
    ...
    model = NN(class_weights=class_weights, out_classes=len(class_weights), **vars(args)).load_from_checkpoint(args.model)
    ...
    target_layers = [model.F.module.blocks[-1].norm1]
