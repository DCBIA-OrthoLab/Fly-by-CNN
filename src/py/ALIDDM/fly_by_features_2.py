...
def main(args):  
    ...
    train_data = FlyByDataset(df_train,phong_renderer,device, dataset_dir=args.dir, rotate=True)
    val_data = FlyByDataset(df_val,phong_renderer,device , dataset_dir=args.dir, rotate=True)
    test_data = FlyByDataset(df_test,phong_renderer,device,dataset_dir=args.dir, rotate=False)
